PROGRAM miniApp
  ...
  REAL(c_double), pinned, DIMENSION(:,:,:), ALLOCATABLE :: rho,u,v,w,et,p,rad,T,ie,Fx,Fy,Fz,tx,ty,tz,tmp,bar
  REAL(c_double), pinned, DIMENSION(:,:,:), ALLOCATABLE :: Fxx,Fyx,Fzx,Fxy,Fyy,Fzy,Fxz,Fyz,Fzz
  REAL(c_double), pinned, DIMENSION(:,:,:,:), ALLOCATABLE :: RHS
  INTEGER :: i
  ...
  DOUBLE PRECISION, pinned, DIMENSION(:,:,:), ALLOCATABLE :: tmp1,tmp2
  ...
  ALLOCATE( tmp1(ax,ay,az) )
  ALLOCATE( tmp2(ax,ay,az) )
